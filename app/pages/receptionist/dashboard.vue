  ...
  <NuxtLayout name="receptionist">
    ...
    <div v-else class="space-y-6">
      ...
      <div class="bg-gradient-to-l from-primary to-primary-dark text-white rounded-xl p-6 shadow-lg">
        ...
        <p class="text-white/90">إدارة الحجوزات والاستقبال</p>
      </div>
...
import { Calendar, Clock, Users, CheckCircle, User, Phone, Scissors, DollarSign, ArrowLeft, ArrowRight, FileText } from 'lucide-vue-next'
...
const loadBookings = async (page: number = 1, status?: 'pending' | 'completed' | 'cancelled') => {
  ...
  try {
    const result = await fetchAllBookings(page, status)
...
const filters = computed(() => {
  return [
    ...
    { value: 'completed' as const, label: 'مكتملة' },
